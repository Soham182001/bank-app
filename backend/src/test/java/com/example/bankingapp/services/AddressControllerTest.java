...
public class AddressControllerTest {
	...
	@BeforeEach
	public void setup() {
		mvc=MockMvcBuilders.standaloneSetup(addController).build();
	}
		@Test
		public void testUpdateAddress() throws Exception{
			...
			ad.setState("kl");
			Mockito.when(this.addSer.updateAddress(ArgumentMatchers.any(),ArgumentMatchers.any())).thenReturn("successfully updated");
			ObjectMapper mapper = new ObjectMapper();
			String json = mapper.writeValueAsString(ad);
			MvcResult res=mvc.perform(put("/updateAddress/{custId}","user0002")
